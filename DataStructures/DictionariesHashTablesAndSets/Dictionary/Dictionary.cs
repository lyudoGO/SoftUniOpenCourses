namespace Dictionary
{
    ...
    {
        private const int InitailCapacity = 16;
        ...
        public Dictionary()
        {
            this.slots = new LinkedList<KeyValue<TKey,TValue>>[InitailCapacity];
            this.Count = 0;
        }
        ...
        public TValue Get(TKey key)
        {
            ...
            if (element == null)
            {
                throw new KeyNotFoundException("Key not exists: " + key);
            }
        ...
        private void Grow()
        {
            var newDictionary = new Dictionary<TKey, TValue>(2 * this.Capacity);
        ...
        {
            foreach (var elemetns in this.slots)
            {
                if (elemetns != null)
                {
